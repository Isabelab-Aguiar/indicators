...
const C3: IndicatorDefinition = {
  ...
  shortLabel: 'C3',
  title: 'Pré-Natal',
  subtitle: 'Cuidado no Pré-Natal',
  description:
    'Avalia o acesso e o acompanhamento efetivo das gestantes em relação aos episódios de cuidados necessários no pré-natal.',
  population: 'Gestantes vinculadas à equipe com pré-natal em acompanhamento no período.',
  maxScore: 100,
  criteria: [
    {
      id: 'A',
      ...
      description: 'Sendo a primeira consulta realizada até a 20ª semana gestacional.',
    },
    {
      id: 'B',
      points: 25,
      title: 'Exames preconizados',
      description:
        'Hemograma, tipagem sanguínea, glicemia, HIV, sífilis (VDRL), hepatite B (HBsAg), toxoplasmose, urina e urocultura.',
    },
    {
      id: 'C',
      points: 25,
      title: 'Atendimento odontológico',
      description: 'Pelo menos um atendimento odontológico durante a gestação.',
    },
    {
      id: 'D',
      points: 25,
      title: 'Vacinas em dia',
      description: 'Vacinas dTpa e Hepatite B conforme calendário vacinal da gestante.',
    },
  ],
}
