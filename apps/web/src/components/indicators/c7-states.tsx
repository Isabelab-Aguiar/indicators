...
export function C7EmptyState({ onImport }: { onImport: () => void }) {
  return (
    <div className="border-border flex flex-col items-center justify-center gap-4 rounded-2xl border border-dashed py-24">
      ...
      <div className="text-center">
        <p className="text-foreground text-sm font-semibold">Nenhum registro C7 encontrado</p>
        <p className="text-muted-foreground mt-1 max-w-xs text-xs leading-relaxed">
          Importe uma planilha CSV com os dados de mulheres para visualizar os indicadores de
          prevenção do câncer.
        </p>
      </div>
      <button
...
export function C7SkeletonGrid() {
  return (
