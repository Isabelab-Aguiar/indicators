...
export type AgeRange = '9-14' | '14-24' | '25-49' | '50-64' | '65-69' | ''

const AGE_RANGE_OPTIONS: { value: AgeRange; label: string }[] = [
  { value: '', label: 'Todas' },
  { value: '9-14', label: '9 a 14 anos' },
  { value: '14-24', label: '14 a 24 anos' },
  { value: '25-49', label: '25 a 49 anos' },
  { value: '50-64', label: '50 a 64 anos' },
  { value: '65-69', label: '65 a 69 anos' },
]

const ALL_MICROAREAS = '__all__'

interface C7FiltersProps {
  quad: Quadrimestre
  year: number
  microarea: string
  ageRange: AgeRange
    ...
    <div className="border-border bg-card flex flex-wrap items-end gap-3 rounded-2xl border p-4">
      ...
      <FilterField label="Faixa etária">
        <FilterSelect
          ...
          onValueChange={(v) => onAgeRangeChange(v === '__all_ages__' ? '' : (v as AgeRange))}
        >
