...
export function C4EmptyState({ onImport }: { onImport: () => void }) {
  return (
    <div className="border-border flex flex-col items-center justify-center gap-4 rounded-2xl border border-dashed py-24">
      ...
      <div className="text-center">
        <p className="text-foreground text-sm font-semibold">Nenhum paciente cadastrado</p>
        <p className="text-muted-foreground mt-1 max-w-xs text-xs leading-relaxed">
          Importe um CSV para visualizar os indicadores de cuidado a pessoas com diabetes C4.
        </p>
      </div>
      <button
        type="button"
...
export function C4SkeletonGrid() {
  return (
