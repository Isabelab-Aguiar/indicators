  ...
  return (
    <div className="border-border flex flex-col items-center justify-center gap-4 rounded-2xl border border-dashed py-24">
      ...
      <div className="text-center">
        <p className="text-foreground text-sm font-semibold">Nenhuma gestante cadastrada</p>
        <p className="text-muted-foreground mt-1 max-w-xs text-xs leading-relaxed">
          Cadastre gestantes ou importe uma planilha para visualizar os indicadores do pré-natal C3.
        </p>
      </div>
      <Link
        href="/importar"
