...
import { C4PatientDrawer } from './c4-patient-drawer'

type DrawerFilter = 'achieved' | 'not-achieved' | null

interface C4CriterionChartProps {
...
export function C4CriterionChart({ stat, patients, animationDelay = 0 }: C4CriterionChartProps) {
