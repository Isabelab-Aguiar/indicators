...
ALTER TYPE "public"."audit_action" ADD VALUE 'ACCESS_REQUEST_APPROVED';--> statement-breakpoint
ALTER TYPE "public"."audit_action" ADD VALUE 'ACCESS_REQUEST_REJECTED';--> statement-breakpoint
ALTER TYPE "public"."audit_entity" ADD VALUE 'access_request';--> statement-breakpoint
...
ALTER TABLE "c2_scores" ADD COLUMN "birth_date" date;--> statement-breakpoint
DO $$ BEGIN
